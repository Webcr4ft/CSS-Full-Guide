...
> **Note:** A `space` is used between the parent and child selector.
...
|---------------|:----------:|-----------------|
| **Descendant Combinator** | `(space)` | Selects all matching descendant elements nested inside another element. |
| **Child Combinator** | `>` | Selects only direct child elements of a specified parent. |
| **Next-Sibling Combinator** | `+` | Selects the element that immediately follows another sibling element. |
| **Subsequent-Sibling Combinator** | `~` | Selects all sibling elements that come after a specified element. |
...
* The **descendant combinator (` `)** selects all matching descendant elements.
* The **child combinator (`>`)** selects only direct children.
* The **next-sibling combinator (`+`)** selects the immediate following sibling.
* The **subsequent-sibling combinator (`~`)** selects all following sibling elements.
* Understanding combinators helps you write cleaner, more precise, and maintainable CSS.

---

> **End of Lesson**
>
> You have learned the four primary CSS combinators:
>
> * Descendant (` `)
> * Child (`>`)
> * Next-Sibling (`+`)
> * Subsequent-Sibling (`~`)
>
> These combinators help you target elements more accurately and create more efficient CSS styles.
